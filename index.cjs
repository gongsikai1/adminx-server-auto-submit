...
(async () => {
  const run = async (username, password) => {
    ...
    const setTokenPromise = async (username, password) => {
      // 识别验证码
      sleep(1)
      const result = await axios.get('https://www.byteout.cn/api/auth/captcha')
      ...
      sleep(1)
      const res = await fetch("https://www.byteout.cn/api/auth/login", {
        "headers": {
          ...
          "Referer": "https://www.byteout.cn/login?redirect=/home",
    ...
    const submitArticle = async () => {
      const article = async () => {
        sleep(1)
        const res = await fetch("https://www.byteout.cn/api/article/save", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "zh-CN,zh;q=0.9",
            ...
            "pragma": "no-cache",
            "proxy-connection": "keep-alive",
            "Referer": "https://www.byteout.cn/article/manage",
            "Referrer-Policy": "strict-origin-when-cross-origin"
          },
    ...
    const addCategory = async () => {
      const category = async () => {
        sleep(1)
        const res = await fetch("https://www.byteout.cn/api/article/category/saveUpdate", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "zh-CN,zh;q=0.9",
            "authorization": `Bearer ${token}`,
            ...
            "pragma": "no-cache",
            "proxy-connection": "keep-alive",
            "Referer": "https://www.byteout.cn/article/category",
            "Referrer-Policy": "strict-origin-when-cross-origin"
          },
    ...
    const addComment = async () => {
      const articleList = async () => {
        sleep(1)
        const res = await await fetch("https://www.byteout.cn/api/article/page?size=10000&current=1&title=", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "zh-CN,zh;q=0.9",
            "authorization": `Bearer ${token}`,
      ...
      const postComment = async (articleId) => {
        sleep(1)
        const res = await fetch("https://www.byteout.cn/api/comment/save", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "zh-CN,zh;q=0.9",
            "authorization": `Bearer ${token}`,
            ...
            "pragma": "no-cache",
            "proxy-connection": "keep-alive",
            "Referer": `https://www.byteout.cn/article/detail/${articleId}`,
            "Referrer-Policy": "strict-origin-when-cross-origin"
          },
          "body": JSON.stringify({
            articleId,
